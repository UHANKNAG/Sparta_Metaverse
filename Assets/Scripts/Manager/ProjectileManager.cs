...
public class ProjectileManager : MonoBehaviour
{
    ...
    public void ShootBullet(RangeWeaponHandler rangeWeaponHandler, Vector2 startPosition, Vector2 direction) {
        GameObject origin = projecttilePrefabs[rangeWeaponHandler.BulletIndex];
    ...
    public void CreateImpactParticleAtPositon(Vector3 position, RangeWeaponHandler weaponHandler) {
